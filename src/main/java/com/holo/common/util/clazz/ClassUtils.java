package com.holo.common.util.clazz;
...
public class ClassUtils {
	 ...
	 */
    public static Map<String,Object[]> compare2obj(Object obj1,Object obj2){
    	Map<String,Object[]> ret=new HashMap<String, Object[]>();
        if(obj1==null || obj2==null)return ret;
        //先把obj1的所有set找到。
        Class clazzObj1=obj1.getClass();
        //所有方法
        ArrayList<String> allMethod=showClassMethordsFull(clazzObj1);
        String getMethod="";
        int atget=-1;
        Object value1=null;
        Object value2=null;
        for (String string : allMethod) {
            ...
            if(atget==-1)continue;
            String Field=string.substring(atget+4,string.length()-1);
            getMethod="get"+Field;
            value1=invokeMethod(obj1, getMethod,null);
            value2=invokeMethod(obj2, getMethod,null);
            //System.out.println("Field=" + Field+",value1="+value1+",value2="+value2);
            if((value1==null && value2 ==null)){
            	
            }else if((value1==null && value2 !=null)
            		||(value1!=null && value2 ==null)
            		||(!value1.equals(value2))){
            	ret.put(Field, new Object[]{value1, value2});
            }
        }
        return ret;
    }
