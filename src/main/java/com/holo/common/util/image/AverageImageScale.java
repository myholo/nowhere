package com.holo.common.util.image;
...
import com.holo.common.util.image.ImageUtils.Position;
...
public class AverageImageScale {
	 ...
	 * @throws IOException
	 */
	public static void resizeFixWithWidth(final File srcFile, File destFile, int width) throws IOException {
		...
		resizeFix(srcFile, destFile, width, height);
	}
	/**
	 * 缩小图片以高度等比
	 * 
	 ...
	 * @throws IOException
	 */
	public static void resizeFix(final File srcFile, File destFile, int boxWidth,
