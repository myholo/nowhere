 ...
 * 时间类工具
 */
package com.holo.common.util.string;
...
public class DateUtils{
	...
	/**
	 * 
	 * 函数说明：根据ymd类型返回yyyy-MM-dd 
	 * @param Date date
	 * @return 
	 * @throws 
	 */
	public static String getYMDForT(String ymd){
	 ...
	 * @return
	 */
	public static Date yesterdayThisTime(){
		Calendar calendar = Calendar.getInstance();
		calendar.add(Calendar.DATE, -1);
		return calendar.getTime();
	}
	...
	public static String oneWeekAgo(){
		...
		calendar.set(Calendar.HOUR_OF_DAY,-24*7);//7天前
		calendar.set(Calendar.MINUTE, 0);
		calendar.set(Calendar.SECOND, 0);
	 ...
	 * @return
	 */
	public static String severalDaysAgo(Integer num){
		num=(num==null)?7:num;
		SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		Calendar calendar = Calendar.getInstance();
		calendar.add(Calendar.MONTH, 0); 
		calendar.set(Calendar.HOUR_OF_DAY,-24*num);//num天前
		calendar.set(Calendar.MINUTE, 0);
		calendar.set(Calendar.SECOND, 0);
		return format.format(calendar.getTime());	
	}
	 ...
	 * @return
	 */
	public static Date DateUtilLastMonth1st(Date date){
		if(date==null)
			date=new Date();
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(date);
	 ...
	 * @return
	 */
	public static Date DateUtilThisMonth1st(Date date){
		if(date==null)
			date=new Date();
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(date);
	 ...
	 * @return
	 */
	public static Date DateUtilNextMonth1st(Date date){
		if(date==null)
			date=new Date();
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(date);
	 ...
	 * @return
	 */
	public static boolean DateUtilIs31th1(Date date){
		if(date==null)
			date=new Date();
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(date);
	 ...
	 * @return
	 */
	public static boolean DateUtilIs1th(Date date){
		if(date==null)
			date=new Date();
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(date);
